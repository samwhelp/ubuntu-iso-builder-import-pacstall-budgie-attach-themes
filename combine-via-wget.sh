...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-budgie-theme-vimix-attach-themes"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-vimix-attach-themes/iso-profile
"
echo
