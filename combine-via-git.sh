...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-budgie-attach-themes"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-attach-themes/iso-profile
"
echo
